...
# WADI 19
python main.py --run_times 5 --anomaly_ratio 1.0 --dataset WADI --data_path ./data/WADI/ --input_c 123 --d_model 123 --output_c 123
...
# NIPS_TS_CreditCard ;Note: Real anomaly ratio is ~0.17%. 
python main.py --run_times 5 --anomaly_ratio 1.0 --dataset NIPS_TS_Creditcard --data_path ./data/NIPS_TS_Creditcard/ --input_c 29 --d_model 29 --output_c 29